...
export class AutoCloseService {
    ...
    public isTargetTogglingElementFactory(
        getTogglingElement?: SubscriptionSpecFactorySpec['getTogglingElement']
    ...
    public isTargetInsideFactory(
        getElementsInside?: SubscriptionSpecFactorySpec['getElementsInside']
